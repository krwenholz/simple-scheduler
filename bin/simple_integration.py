...
print(put_event_request('specialist_1', 'specialist_1', month_start + 1200).read())
print(put_event_request('specialist_1', 'specialist_1', month_start + 2400).read())
...
print(delete_event_request('specialist_1', 'specialist_1', month_start + 1200).read())
print(delete_event_request('specialist_1', 'specialist_1', month_start + 2400).read())
